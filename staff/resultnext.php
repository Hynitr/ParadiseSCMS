          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Upload Result Details for <strong> <?php echo $rower['SurName']." ".$rower['Middle Name']." ".$rower['Last Name'] ?></strong> - <?php echo $term ?> </h3>
              ...
              <div class="card-body">
               ...
               <div class="form-group">
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <input type="number" name="date" id="attd" placeholder="Attendance" class="form-control">
                  </div>
                  <!-- /.input group -->
                  <div class="form-group col-md-2">
                     <label for="exampleInputEmail1">Punctuality.:</label>
                    <input type="number" name="month" id="punc" placeholder="Punctuality" class="form-control">
                  </div>
                  <!-- /.input group -->
                   <div class="form-group col-md-2">
                     <label for="exampleInputEmail1">Honesty.:</label>
                    <input type="number" name="year" id="hons" placeholder="Honesty" class="form-control">
                  </div>
                  <!-- /.input group -->
                   <div class="form-group col-md-2">
                     <label for="exampleInputEmail1">Neatness.:</label>
                    <input type="number" name="year" id="neat" placeholder="Neatness" class="form-control">
                  </div>
                  <!-- /.input group -->
                  <div class="form-group col-md-2">
                     <label for="exampleInputEmail1">Non-aggr.:</label>
                    <input type="number" name="year" id="nonaggr" placeholder="Non Aggresiveness" class="form-control">
                  </div>
                  <!-- /.input group -->
                 <div class="form-group col-md-2">
                     <label for="exampleInputEmail1">Leadership Skill.:</label>
                    <input type="number" name="year" id="ldsk" placeholder="Leadership Skill" class="form-control">
                  </div>
                  <!-- /.input group -->
               ...
               <div class="form-group">
                 ...
                 <div class="form-group col-md-2">
                    ...
                    <input type="number" name="date" id="sprt" placeholder="Sport" class="form-control">
                  </div>
                  <!-- /.input group -->
                   <div class="form-group col-md-2">
                     <label for="exampleInputEmail1">Societies.:</label>
                    <input type="number" name="month" id="soci" placeholder="Societies" class="form-control">
                  </div>
                  <!-- /.input group -->
                   <div class="form-group col-md-2">
                     <label for="exampleInputEmail1">Youth Organ.:</label>
                    <input type="number" name="year" id="yth" placeholder="Youth Organ" class="form-control">
                  </div>
                  <!-- /.input group -->
                  <div class="form-group col-md-2">
                     <label for="exampleInputEmail1">Aesthetics.:</label>
                    <input type="number" name="year" id="aes" placeholder="Aesthetics" class="form-control">
                  </div>
                  <!-- /.input group -->
                  <div class="form-group col-md-4">
                     <label for="exampleInputEmail1">Relationship with others.:</label>
                    <input type="number" name="year" id="rel" placeholder="Relationship" class="form-control">
                  </div>

                   <div class="form-group col-md-3">
                     <label for="exampleInputEmail1">Times school opened.:</label>
                    <input type="number" name="year" id="tso" placeholder="Times school opened" class="form-control">
                  </div>

                  <div class="form-group col-md-3">
                     <label for="exampleInputEmail1">Times student absent.:</label>
                    <input type="number" name="year" id="tsa" placeholder="Times student absent" class="form-control">
                  </div>

                  <div class="form-group col-md-3">
                     <label for="exampleInputEmail1">Times student present.:</label>
                    <input type="number" name="year" id="tsp" placeholder="Times student present" class="form-control">
                  </div>
                     

<?php
$sql = "SELECT sum(sn) AS pss FROM result WHERE `admno` = '$data' AND `class` = '$cls' AND `term` = '$term'";
$ssl = "SELECT sum(total) AS mobt FROM result WHERE `admno` = '$data' AND `class` = '$cls' AND `term` = '$term'";
$ds   = query($sql);
$ress = query($ssl);
...
?>
                   <div class="form-group col-md-3">
                    ...
                    <input type="number" name="year" id="mrkps" value="<?php echo $mrkpos ?>" class="form-control" disabled>
                  </div>

                   <div class="form-group col-md-3">
                     <label for="exampleInputEmail1">Mark Obtained.:</label>
                    <input type="number" name="year" id="mrkbt" value="<?php echo $mrkobt ?>" class="form-control" disabled>
                  </div>

                   <div class="form-group col-md-3">
                     <label for="exampleInputEmail1">Percentage.:</label>
                    <input type="text" name="year" id="perci" value="<?php echo $perc ?>%" class="form-control" disabled>
                  </div>

                  <div class="form-group col-md-3">
                     <label for="exampleInputEmail1">Total Grade.:</label>
                    <input type="text" name="year" id="tog" value="<?php echo $grade ?>" class="form-control" disabled>
                  </div>                    
 ...
 ?>                    
               ...
               <div class="form-group col-md-3">
                   <label for="exampleInputEmail1">Promoted .:</label>                  
                    <input type="text" name="year" id="pro" value="<?php echo $rep ?>" class="form-control" disabled>
                  </div>
<?php
} else {
  if ($cls == 'Basic 1') {
...
?>    
               ...
               <div class="form-group col-md-3">
                   <label for="exampleInputEmail1">Promoted .:</label>                  
                    <input type="text" id="pro" value="<?php echo $rep ?>" class="form-control" disabled>
                  </div>
...
?>                  
            ...
            <optgroup label="Attitude">
              ...
              <option id="prin">Exhibits a positive outlook and attitude in the classroom.</option>
              ...
              <option id="prin">Uses instincts to deal with matters independently and in a positive way.</option>
            ...
            <optgroup label="Behavior">
              <option id="prin">cooperates consistently with the teacher and other students.</option>
              <option id="prin">transitions easily between classroom activities without distraction.</option>
              ...
              <option id="prin">sets an example of excellence in behavior and cooperation.</option>
            </optgroup>
            <optgroup label="Character">
              <option id="prin">shows respect for teachers and peers.</option>
  <option id="prin">treats school property and the belongings of others with care and respect.</option>
  ...
  <option id="prin">is kind, respectful and helpful when interacting with his/her peers</option>
  <option id="prin">is respectful of other students in our classroom and the school community</option>
  <option id="prin">demonstrates responsibility daily by caring for the materials in our classroom carefully and thoughtfully</option>
  <option id="prin">takes his/her classroom jobs seriously and demonstrates responsibility when completing them</option>
  <option id="prin">is always honest and can be counted on to recount information when asked</option>
  <option id="prin">is considerate when interacting with his/her teachers</option>
  <option id="prin">demonstrates his/her manners on a daily basis and is always respectful</option>
  <option id="prin">has incredible self-discipline and always gets his/her work done in a timely manner</option>
  <option id="prin">can be counted on to be one of the first students to begin working on the task that is given</option>
  <option id="prin">perseveres when faced with difficulty by asking questions and trying his/her best</option>
  <option id="prin">does not give up when facing a task that is difficult and always does his/her best</option>
  <option id="prin">is such a caring boy/girl and demonstrates concern for his/her peers</option>
  <option id="prin">demonstrates his/her caring nature when helping his/her peers when they need the assistance</option>
  <option id="prin">is a model citizen in our classroom</option>
  <option id="prin">is demonstrates his/her citizenship in our classroom by helping to keep it clean and taking care of the materials in it</option>
  <option id="prin">can always be counted on to cooperate with his/her peers</option>
  <option id="prin">is able to cooperate and work well with any of the other students in the class</option>
  <option id="prin">is exceptionally organized and takes care of his/her things</option>
  ...
  <option id="prin">is thoughtful and kind in his/her interactions with others</option>
  <option id="prin">is creative when problem solving</option>
  <option id="prin">is very hardworking and always completes all of his/her work</option>
  <option id="prin">is patient and kind when working with his/her peers who need extra assistance</option>
  <option id="prin">trustworthy and can always be counted on to step in and help where needed</option>
            </optgroup>
  ...
  <option id="prin">expresses ideas clearly, both verbally and through writing.</option>
  ...
  <option id="prin">listens to the comments and ideas of others without interrupting.</option>
            </optgroup>
             <optgroup label="Group Work">
              <option id="prin">offers constructive suggestions to peers to enhance their work.</option>
  <option id="prin">accepts the recommendations of peers and acts on them when appropriate.</option>
  <option id="prin">is sensitive to the thoughts and opinions of others in the group.</option>
  <option id="prin">takes on various roles in the work group as needed or assigned.</option>
  ...
  <option id="prin">displays and talks about personal items from home when they relate to topics of study.</option>
  <option id="prin">provides background knowledge about topics of particular interest to them.</option>
  <option id="prin">has an impressive understanding and depth of knowledge about their interests.</option>
  <option id="prin">seeks additional information independently about classroom topics that pique interest.</option>
  ...
  <option id="prin">responds to what has been read or discussed in class and as homework.</option>
  ...
  <option id="prin">chooses to spend free time with friends.</option>
             ...
             <optgroup label="Time Management">
              <option id="prin">tackles classroom assignments, tasks, and group work in an organized manner.</option>
  ...
  <option id="prin">works at an appropriate pace, neither too quickly or slowly.</option>
  ...
  <option id="prin">creates impressive home projects.</option>
                  ...
                  <p class="text-danger">Make sure you recheck all details typed in before submitting</p>
                   ...
                   <button type="button" id="subdone" class="btn float-right btn-primary btn-outline-light">Submit Result</button>
