        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <div style="width: 227px; background-color: gold;" class="card">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      <h2 class="lead"><b>Opeyemi Nifemi</b></h2>
                      <p class="text-sm">Gender: <b>Female</b>
                        <span class="row" style="">PMS/STUD/2020/1084</span>
                      </p>
                      
                     <img width="150px" height="150px" src="https://admin.paradisemodelschool.com.ng/upload/QRCard/PMSSTUD20201084.png">                    
                    </div>
                    <div class="col-5 text-center">
                      
                      <img width="85px" height="90px" src="upload/studentDP/wbsklnw.jpg" alt="" class="img-circle">                    </div>
                  </div>
                </div>
